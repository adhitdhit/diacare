...
export function AssessmentPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-red-50 via-rose-50 to-orange-50 flex items-center justify-center p-4 py-8">
          ...
          <CardContent className="pt-8 pb-8">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-3">
                  ...
                  >
                    <div className="flex flex-col items-center gap-3">
                      <div className={`w-16 h-16 rounded-full flex items-center justify-center transition-all ${
                        ...
                        <svg className={`w-8 h-8 ${gender === 'male' ? 'text-white' : 'text-gray-500'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                        </svg>
                      </div>
                      <span className={`font-semibold text-base ${gender === 'male' ? 'text-red-700' : 'text-gray-700'}`}>
                        Laki-laki
                      </span>
                    </div>
                  </button>
                  ...
                  >
                    <div className="flex flex-col items-center gap-3">
                      <div className={`w-16 h-16 rounded-full flex items-center justify-center transition-all ${
                        ...
                        <svg className={`w-8 h-8 ${gender === 'female' ? 'text-white' : 'text-gray-500'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                        </svg>
                      </div>
                      <span className={`font-semibold text-base ${gender === 'female' ? 'text-red-700' : 'text-gray-700'}`}>
                        Perempuan
                      </span>
                    </div>
                  </button>
                ...
                {!gender && (
                  <p className="text-sm text-gray-500 text-center">Pilih jenis kelamin pasien</p>
                )}
              </div>
